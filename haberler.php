...
<head>
  <meta charset="UTF-8">
  <title>Efe Group | Haberler</title>
...
$sqlhaber=mysqli_query($db,"select * from newscast");
?>
</head>
...
<div class="container main ">
  <div class="row"> 
    <?php while ($haber=mysqli_fetch_array($sqlhaber)){ ?>
    <div class="col-md-6">
      <div class="card">
        <div class='imgContainer'> <img src='<?php echo "img/haberler/".$haber['Newscast_img']; ?>'> </div>
        <h2><?php echo $haber['Newscast_title'];?></h2>
        <div class="content">
          <p><?php echo $haber['Newscast_text'];?></p>
        </div>
      </div>
    </div>
    <?php } ?>  
