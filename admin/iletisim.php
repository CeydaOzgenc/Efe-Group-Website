...
<?php
    ...
    if(!$_SESSION)
    {
        ...
        header("refresh:0;url=index.php");
            ...
            $mesaj=mysqli_query($db,"select * from contact_mesaj");
            if(p("btngnc")=="Güncelle")
            {
                if(p("contact_call")!="" and p("contact_mail")!="" and p("contact_adres")!=""){
                    mysqli_query($db,"update contact set Contact_call='".p("contact_call")."', Contact_mail='".p("contact_mail")."' , Contact_maps='".p("contact_adres")."'") ;
                }else{
                            ...
                            <div class="col-xl-12 col-md-6">
                                <div class="card text-white mb-4">
                                    <form method="post">
                                        ...
                                        <div class="card-body">
                                            <?php $sqlcontact=mysqli_fetch_array($contact); ?>
                                            <div class="col-xl-6 col-md-6" style="color:#000;  margin: 2%;">
                                                <h3>Telefon Numarası</h3><br>
                                                <input class="form-control profil-form" type="text" name="contact_call" value="<?php echo $sqlcontact['Contact_call']; ?>">
                                            </div>
                                            <div class="col-xl-6 col-md-6" style="color:#000;  margin: 2%;">
                                                <h3>Mail</h3><br>
                                                <input class="form-control profil-form" type="text" name="contact_mail" value="<?php echo $sqlcontact['Contact_mail']; ?>">
                                            </div>
                                            <div class="col-xl-6 col-md-6" style="color:#000;  margin: 2%;">
                                                <h3>Adres</h3><br>
                                                <input class="form-control profil-form" type="text" name="contact_adres" value="<?php echo $sqlcontact['Contact_maps']; ?>">
                                            </div>
                                ...
                                <div class="card text-white mb-4">
                                    ...
                                    <div class="card-body">
                                        <table id="datatablesSimple">
                                            ...
                                            <tbody>
                                            <?php while ($mesajlar=mysqli_fetch_array($mesaj)){ ?>
                                                <tr>
                                                    <td>
                                                        <?php   $uzanti=explode(".",$mesajlar['ContactMesaj_file']);
                                                                if($mesajlar['ContactMesaj_file']==""){
                                                                    echo "Dosya Yok";
                                                                }else{?>
                                                                        <iframe src="<?php echo "../dosyalar/".$mesajlar['ContactMesaj_file']; ?>" width="400px" height="400px" ></iframe>
                                                                <?php } ;?>
                                                    </td>
                                                    <td><?php echo $mesajlar['ContactMesaj_isim'];?></td>
                                                    <td><?php echo $mesajlar['ContactMesaj_mail'];?></td>
                                                    <td><?php echo $mesajlar['ContactMesaj_call'];?></td>
                                                    <td><?php echo $mesajlar['ContactMesaj_konu'];?></td>
                                                    <td><?php echo $mesajlar['ContactMesaj_mesaj'];?></td>
                                                    <td>
                                                        <a href="<?php echo 'sil.php?yer=m&sil='.$mesajlar["ContactMesaj_id"] ?>">
