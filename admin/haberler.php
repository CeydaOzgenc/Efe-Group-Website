...
<?php
    ...
    if(!$_SESSION)
    {
        ...
        $haberler = mysqli_query($db,"select * from newscast");
?>
<html>
    <head>
        <meta charset="utf-8" />
                                ...
                                <div class="card text-white mb-4">
                                    ...
                                    <div class="card-body">
                                        <table id="datatablesSimple">
                                            <thead>
                                                <tr>
                                                    <th style="width: 25% !important;">Haber Fotografı</th>
                                                    <th>Haber Başlığı</th>
                                                    <th>Haber Yazısı</th>
                                            ...
                                            <tbody>
                                            <?php while ($haber=mysqli_fetch_array($haberler)){ ?>
                                                <tr>
                                                    <td><img class="blog_img" src="<?php echo "../img/haberler/".$haber['Newscast_img']; ?>" /></td>
                                                    <td><?php echo $haber['Newscast_title'];?></td>
                                                    <td><?php echo $haber['Newscast_text'];?></td>
                                                    <td>
                                                        <a href="<?php echo "duzen.php?yer=h&duzen=".$haber["Newscast_id"] ?>">
                                                            <input class="btn btn-primary" type="submit" value="Düzenle">
                                                        </a>
                                                        <a href="<?php echo 'sil.php?yer=h&sil='.$haber["Newscast_id"] ?>">
                                    ...
                                    <div class="card-footer bg-primary d-flex align-items-center justify-content-between">
                                        <a class="small text-white" href="ekle.php?yer=h">Yeni Ekle</a>
