                                ...
                                <div class="card text-white mb-4">
                                    ...
                                    <div class="card-body">
                                        <table id="datatablesSimple">
                                            <thead>
                                                <tr>
                                                    <th style="width: 25% !important;">Üretim Fotografı</th>
                                                    <th>Üretim Yazısı</th>
                                            ...
                                            <?php while ($sqldongu=mysqli_fetch_array($sql)){ ?>
                                                <tr>
                                                    <td><img class="blog_img" src="<?php echo '../img/uretim/'.$sqldongu['Production_img']; ?>" /></td>
                                                    <td><?php echo $sqldongu['Production_text']; ?></td>
                                                    <td>
                                                        <a href="<?php echo "duzen.php?yer=ur&duzen=".$sqldongu["Production_id"];?>">
                                                            <input class="btn btn-primary" type="submit" value="Düzenle">
                                                        </a>
                                                        <a href="<?php echo 'sil.php?yer=ur&sil='.$sqldongu["Production_id"] ?>">
                                    ...
                                    <div class="card-footer bg-primary d-flex align-items-center justify-content-between">
                                        <a class="small text-white" href="ekle.php?yer=ur">Yeni Ekle</a>
