...
<?php
    ...
    if(!$_SESSION)
    {
        ...
        $slider= mysqli_query($db,"select * from ssorumluluk");
?>
<html>
    <head>
        <meta charset="utf-8" />
                                ...
                                <div class="card text-white mb-4">
                                    ...
                                    <div class="card-body">
                                        <table id="datatablesSimple">
                                            <thead>
                                                <tr>
                                                    <th style="width: 25% !important;">Sosyal Sorumluluk Fotografı</th>
                                                    <th>Sosyal Sorumluluk Başlığı</th>
                                                    <th>Sosyal Sorumluluk Yazısı</th>
                                            ...
                                            <?php while ($slide=mysqli_fetch_array($slider)){ ?>
                                                <tr>
                                                    <td><img class="blog_img" src="<?php echo "../img/ssorumluluk/".$slide['Ssorumluluk_img']; ?>" /></td>
                                                    <td><?php echo $slide['Ssorumluluk_title'];?></td>
                                                    <td><?php echo $slide['Ssorumluluk_text'];?></td>
                                                    <td>
                                                        <a href="<?php echo "duzen.php?yer=s&duzen=".$slide["Ssorumluluk_id"] ?>">
                                                            <input class="btn btn-primary" type="submit" value="Düzenle">
                                                        </a>
                                                        <a href="<?php echo 'sil.php?yer=s&sil='.$slide["Ssorumluluk_id"] ?>">
                                    ...
                                    <div class="card-footer bg-primary d-flex align-items-center justify-content-between">
                                        <a class="small text-white" href="ekle.php?yer=s">Yeni Ekle</a>
