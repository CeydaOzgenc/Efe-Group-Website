                                ...
                                <div class="card text-white mb-4">
                                    ...
                                    <div class="card-body">
                                        <table id="datatablesSimple">
                                            <thead>
                                                <tr>
                                                    <th style="width: 25% !important;">Sertifika Fotografı</th>
                                            ...
                                            <?php while ($sqldongu=mysqli_fetch_array($sql)){ ?>
                                                <tr>
                                                    <td><img class="blog_img" src="<?php echo '../img/seltifica/'.$sqldongu['Seltificas_img']; ?>" /></td>
                                                    <td>
                                                        <a href="<?php echo 'sil.php?yer=se&sil='.$sqldongu["Seltificas_id"] ?>">
                                    ...
                                    <div class="card-footer bg-primary d-flex align-items-center justify-content-between">
                                        <a class="small text-white" href="ekle.php?yer=se">Yeni Ekle</a>
