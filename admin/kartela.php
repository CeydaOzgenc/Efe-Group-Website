                                ...
                                <div class="card text-white mb-4">
                                    ...
                                    <div class="card-body">
                                        <table id="datatablesSimple">
                                            <thead>
                                                <tr>
                                                    <th style="width: 25% !important;">Kartela Fotografı</th>
                                            ...
                                            <?php while ($sqldongu=mysqli_fetch_array($sql)){ ?>
                                                <tr>
                                                    <td><img class="blog_img" src="<?php echo '../img/kartela/'.$sqldongu['Kartela_img']; ?>" /></td>
                                                    <td>
                                                        <a href="<?php echo 'sil.php?yer=k&sil='.$sqldongu["Kartela_id"] ?>">
                                    ...
                                    <div class="card-footer bg-primary d-flex align-items-center justify-content-between">
                                        <a class="small text-white" href="ekle.php?yer=k">Yeni Ekle</a>
