...
<?php
    ...
    if(!$_SESSION)
    {
        ...
        $urunleryaz=mysqli_query($db,"select * from product_main");
                            ...
                            <div class="col-xl-12 col-md-6">
                                <div class="card text-white mb-4">
                                    ...
                                    <div class="card-body">
                                        <table id="datatablesSimple">
                                            ...
                                            <?php while ($urunyaz=mysqli_fetch_array($urunleryaz)){ ?>
                                                <tr>
                                                    <td><?php echo $urunyaz["ProductMain_name"] ?></td>
                                                    <td><img class="blog_img" src="<?php echo '../img/urunler/'.$urunyaz["ProductMain_img"]; ?>" /></td>
                                                    <td>
                                                        <a href="<?php echo "duzen.php?yer=u&duzen=".$urunyaz["ProductMain_id"] ?>">
                                                            <input class="btn btn-primary" type="submit" value="Düzenle">
                                                        </a>
                                                        <?php if($urunyaz["ProductMain_id"]!=1){ ?>
                                                        <a href="<?php echo 'sil.php?yer=u&sil='.$urunyaz["ProductMain_id"] ?>">
                                    ...
                                    <div class="card-footer bg-primary d-flex align-items-center justify-content-between">
                                        <a class="small text-white" href="ekle.php?yer=u">Yeni Ekle</a>
